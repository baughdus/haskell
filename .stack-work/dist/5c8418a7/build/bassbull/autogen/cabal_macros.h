...
/* package bassbull-0.1.0.0 */
#ifndef VERSION_bassbull
#define VERSION_bassbull "0.1.0.0"
#endif /* VERSION_bassbull */
#ifndef MIN_VERSION_bassbull
#define MIN_VERSION_bassbull(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bassbull */
...
#define CURRENT_COMPONENT_ID "bassbull-0.1.0.0-9Jwnww51hqkAMmQF1nSV6b-bassbull"
